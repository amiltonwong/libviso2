...
img_dir     = '/data/karlsruhe_sequences/2010_03_09_drive_0019';

% push back first image
I = imread('/data/karlsruhe_sequences/2010_03_09_drive_0019/I1_000000.png');
matcherMex('push',I);
...
% start matching
for i=1:6
  I = imread(['/data/karlsruhe_sequences/2010_03_09_drive_0019/I1_' num2str(i,'%06d') '.png']);
