...
public:
    ...
    void setupUi(QDialog *MainDialog)
    {
        ...
        verticalLayout_2 = new QVBoxLayout(tabReconstruction);
        ...
        sizePolicy.setHeightForWidth(leftImageView->sizePolicy().hasHeightForWidth());
        leftImageView->setSizePolicy(sizePolicy);

        gridLayout->addWidget(leftImageView, 0, 0, 1, 1);
        ...
        sizePolicy2.setHeightForWidth(modelView->sizePolicy().hasHeightForWidth());
        modelView->setSizePolicy(sizePolicy2);
        modelView->setSizeIncrement(QSize(0, 0));

        verticalLayout->addWidget(modelView);
        ...
        sizePolicy3.setHeightForWidth(recordPosesPushButton->sizePolicy().hasHeightForWidth());
        recordPosesPushButton->setSizePolicy(sizePolicy3);
        ...
        sizePolicy4.setHeightForWidth(backgroundWallCheckBox->sizePolicy().hasHeightForWidth());
        backgroundWallCheckBox->setSizePolicy(sizePolicy4);
        ...
        sizePolicy3.setHeightForWidth(showCamerasCheckBox->sizePolicy().hasHeightForWidth());
        showCamerasCheckBox->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(gridCheckBox->sizePolicy().hasHeightForWidth());
        gridCheckBox->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(whiteCheckBox->sizePolicy().hasHeightForWidth());
        whiteCheckBox->setSizePolicy(sizePolicy3);
        ...
        sizePolicy.setHeightForWidth(rightImageView->sizePolicy().hasHeightForWidth());
        rightImageView->setSizePolicy(sizePolicy);

        gridLayout->addWidget(rightImageView, 1, 0, 1, 1);

        disparityView = new View2D(tabReconstruction);
        disparityView->setObjectName(QString::fromUtf8("disparityView"));
        sizePolicy.setHeightForWidth(disparityView->sizePolicy().hasHeightForWidth());
        disparityView->setSizePolicy(sizePolicy);

        gridLayout->addWidget(disparityView, 2, 0, 1, 1);
